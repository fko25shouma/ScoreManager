...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/TestRegistExecute.action" method="post" class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="class_num" class="form-select">
                            ...
                            <c:forEach var="c" items="${class_num_set}">
                                <option value="${c}" <c:if var="isMatch" test="${c == class_num}">selected</c:if>>${c}</option>
                            </c:forEach>
                        </select>
                    </div>
        ...
        <div class="mt-4 text-end">
            <a href="${pageContext.request.contextPath}/Menu.action" class="btn btn-secondary">メニューへ戻る</a>
        </div>
    </div>
